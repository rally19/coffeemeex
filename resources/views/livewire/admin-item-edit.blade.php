...
<div>
    ...
    <div class="flex items-center justify-between mb-4">
        <div><flux:heading size="xl">Edit Item ({{ $item->id }}) <span class="font-extrabold">{{ $item->name }}</span></flux:heading></div>
        <div class="flex items-center gap-4">
                                ...
                                @if($item->thumbnail_pic)
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <flux:button variant="danger" wire:click="removeThumbnail" type="button">
                                                {{ __('Remove Thumbnail') }}
                                            </flux:button>
                                        </div>
                                    </div>
                ...
                <div class="space-y-4 outline rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <flux:select wire:model.live="tagTypeFilter" class="w-full">
